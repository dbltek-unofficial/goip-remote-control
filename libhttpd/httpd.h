...
**
**
** $Id: httpd.h,v 1.1.1.1 2012/03/02 02:33:53 elwin Exp $
**
*/
...
typedef struct
{
    ...
    char clientAddr[HTTP_IP_ADDR_LEN],
        ...
        *host;
    unsigned char readBuf[HTTP_READ_BUF_LEN + 1],
        *readBufPtr;
    httpReq request;
    httpRes response;
    httpVar* variables;
...
extern void httpdWrite(httpd*, char*, int);
extern void _httpd_send404(httpd*);
